...
const Select = forwardRef((props, ref) => {
  ...
  const errorComponent = useMemo(() => {
    ...
    if (typeof error === 'string') {
      // TODO: Use error styling here, and move margins to Select component,
  ...
  // on the label for this Select, including the "mouseDown" state users
  // encounter when clicking down on the label (which applies focus styles to
  // only the label, and not the Select).
  //
...
Select.propTypes = {
  ...
  /** Used to mark this input as optional. Will output text in `theme.components.Select.optionalMessage`, if set. */
...
Select.InputComponentStyles = InputComponentStyles;
