...
module.exports = {
  ...
  styleguideComponents: {
    ...
    'slots/CodeTabButton': path.join(__dirname, 'styleguide/components/slots/CodeTabButton'),
    'slots/UsageTabButton': path.join(__dirname, 'styleguide/components/slots/UsageTabButton'),
